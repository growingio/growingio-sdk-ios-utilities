...
@interface GrowingULAppLifecycle : NSObject
...
- (void)addAppLifecycleDelegate:(id<GrowingULAppLifecycleDelegate>)delegate;

- (void)removeAppLifecycleDelegate:(id<GrowingULAppLifecycleDelegate>)delegate;
